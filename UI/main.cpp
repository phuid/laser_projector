...
int main()
{
    ...
    int (encoder::*pt2ConstMember)(float, char, char) const = NULL;
        ...
        .nested_menu_options = {
            ...
            },
            {
                ...
                .nested_menu_options = {
                    ...
                    {
                        .name = const_cast<char *>(std::string("option5").c_str()), // FIXME: segfault when less than 4 options
                        .style = TEXT,
                    },
                },
            },
    ...
    menu_interact(lcd, enc, root, true);
    while (true)
    {
